...
- **[StellarRec](https://stellarrec.netlify.app/dashboard#student)** – An AI-powered platform that helps students apply smarter and lets recommenders send one recommendation to multiple universities with a single upload. Built with Kiro for backend automation and dashboard improvements. **💻 Code](https://github.com/swetharajan7/StellarRec)**
